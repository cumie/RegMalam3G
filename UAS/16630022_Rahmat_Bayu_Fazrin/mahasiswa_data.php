	...
	<div class="left">
		<form class="form-inline" method="get">
			<select name="filter" class="form-control" onchange="form.submit()">
				...
				<option value="fkip" <?php if($filter == 'fkip'){ echo 'selected';}?>>FKIP</option>
				<option value="fkm" <?php if($filter == 'fkm'){ echo 'selected';}?>>FKM</option>
...
<div class="table-responsive">
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<td>
				<?php
				if($row['fakultas'] == 'fkip'){
				?>
				<span class="label label-success">FKIP</span>
				<?php
					}else if($row['fakultas'] == 'fkm'){
				?>	
				<span class="label label-success">FKM</span>
				<?php
					}else if($row['fakultas'] == 'fti'){
				?>
