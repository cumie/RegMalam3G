...
if (isset($_POST['add'])) {
		...
		if (mysqli_num_rows($cek) == 0){
			...
			$insert = mysqli_query($koneksi, "INSERT INTO mahasiswa (npm, nama, tempat_lahir, tanggal_lahir, alamat, no_telpon, prodi, fakultas) VALUES ('$npm', '$nama', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$no_telpon', '$prodi', '$fakultas')") or die(mysqli_error($koneksi));
