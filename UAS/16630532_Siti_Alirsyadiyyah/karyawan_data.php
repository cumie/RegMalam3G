...
$pageSql = "SELECT * FROM karyawan ORDER BY nik ASC";	
if (isset($_POST['qcari'])){
	$qcari = $_POST['qcari'];
	$pageSql = "SELECT * FROM karyawan where nik like '%$qcari%' or nama like '%$qcari%' or no_telpon like '%$qcari%' or tempat_lahir like '%$qcari%'";
}
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<td>
				...
				<a href="karyawan_data.php?aksi=delete&nik=<?php echo $row['nik'];?>" title="Hapus Data" onclick="return confirm('Anda Yakin Ingin Menghapus Data<?php echo $row['nama'];?>')" class="btn btn-danger btn-sm"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
			</td>
