    ...
    <div class="left">
        <form class="form-inline" method="get">
            <select name="filter" class="form-control" onchange="form.submit()">
                ...
                <option value="Algoritma" <?php if($filter == 'Algoritma'){ echo 'selected';}?>>Algoritma</option>
                <option value="Sistem Berkas" <?php if($filter == 'Sistem Berkas'){ echo 'selected';}?>>Sistem Berkas</option>
                <option value="Sistem Basis Data" <?php if($filter == 'Sistem Basis Data'){ echo 'selected';}?>>Sistem Basis Data</option>
            </select>
        </form>
...
<div class="table-responsive">
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td>
                <?php
                if($row['matakuliah'] == 'Algoritma'){
                ?>
                <span class="label label-success">Algoritma</span>
                <?php
                    }else if($row['matakuliah'] == 'Sistem Berkas'){
                ?>  
                <span class="label label-success">Sistem Berkas</span>
                <?php
                    }else if($row['matakuliah'] == 'Sistem Basis Data'){
                ?>
                <span class="label label-success">Sistem Basis Data</span>
                <?php
                }
                ?>
