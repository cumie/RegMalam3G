...
?>
    ...
    <h2>Data pengajar &raquo; Tambah Data</h2>
...
if (isset($_POST['add'])) {
        ...
        if (mysqli_num_rows($cek) == 0){
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO pengajar (nik, nama, tempat_lahir, tanggal_lahir, alamat, no_telpon, fakultas, matakuliah) VALUES ('$nik', '$nama', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$no_telpon', '$fakultas', '$matakuliah')") or die(mysqli_error($koneksi));

            if ($insert) {
                echo '<div class="alert alert-success alert-dismissable"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>Data pengajar Berhasil Disimpan.</div>';
            }else{
                echo '<div class="alert alert-danger alert-dismissable"> <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>Data pengajar Berhasil Disimpan.</div>';
            }
        }else{
        ...
        <label class="col-sm-3 control label">matakuliah</label>
            <div class="col-sm-2">
                <select name="matakuliah" class="form-control" required>
                    ...
                    <option value="Sistem Berkas">Sistem Berkas</option>
