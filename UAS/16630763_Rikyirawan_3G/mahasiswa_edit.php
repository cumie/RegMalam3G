...
if (isset($_POST['save'])) {
		...
		$jabatan 			= $_POST['prodi'];
		$status 			= $_POST['fakultas'];



			$update = mysqli_query($koneksi, "UPDATE mahasiswa SET nama='$nama', tempat_lahir='$tempat_lahir', tanggal_lahir='$tanggal_lahir', alamat='$alamat', nomor_telpon='$nomor_telpon', prodi='$prodi', fakultas='$fakultas' WHERE npm='$npm'") or die(mysqli_error($koneksi));
...
<form class="form-horizontal" action="" method="post">
	...
	<div class="form-group">
		<label class="col-sm-3 control label">No Telepon</label>
			<div class="col-sm-3">
				<input type="text" name="nomor_telpon" value="<?php echo $row['nomor_telpon'];?>" class="form-control" placeholder="No Telpon" required>
			</div>
	</div>
	<div class="form-group">
