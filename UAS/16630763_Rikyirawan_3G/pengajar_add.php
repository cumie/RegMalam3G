...
if (isset($_POST['add'])) {
        ...
        if (mysqli_num_rows($cek) == 0){
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO pengajar (nik, nama, tempat_lahir, tanggal_lahir, alamat, nomor_telpon, fakultas, matakuliah) VALUES ('$nik', '$nama', '$tempat_lahir', '$tanggal_lahir', '$alamat', '$nomor_telpon', '$fakultas', '$matakuliah')") or die(mysqli_error($koneksi));
