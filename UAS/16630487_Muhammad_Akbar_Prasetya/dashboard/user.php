    ...
    <form method="POST" action="">
      <table class="table" id="user">
        <caption><h3>Edit Data User</h3></caption>
          ...
          <tr><td></td><td><a href="index.php?menu=data_user" class="btn btn-danger"> Kembali Ke Data User</a> <input type="submit" class="btn btn-success" name="edit_user" value="Edit User"></td></tr>
      </table>
    </form>
<?php 
