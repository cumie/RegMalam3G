...
<head>
  ...
  <title>Login Ke Halaman Administrator</title>
  <!-- Bootstrap core CSS -->
  ...
  <div class="col-md-4 col-sm-8 col-md-offset-4" style="padding-top:100px">
        ...
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Masuk</button>
            ...
            <div class="separator">
              <div><h3 align="center"> UAS PEMROGRAMAN WEB</h2><p align="center">&copy; 2018 - UAS Pemrograman WEB dengan PHP - Developer : Muhammad Akbar Prasetya</p></div>
            </div>
          </form>
    </div>
  </div>
